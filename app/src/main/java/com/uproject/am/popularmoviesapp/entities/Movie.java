...
public class Movie implements Parcelable {
    ...
    public String getImageFullURL() {
        return Constants.MovieDbAPIConstants.IMAGE_BASE_URL + Constants.MovieDbAPIConstants.IMAGE_SMALL_SIZE + getPosterPath();
    }
    ...
    public String getRating() {
        return getVoteAverage() + "/" + Constants.MovieDbAPIConstants.RATING_MAX;
    }
